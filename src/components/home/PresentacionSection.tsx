...
const PresentacionSection = () => {
  return (
    <div className="bgGray py-8 px-4 md:px-8">
      {/* Card del Podcast */}
      <div className="presentation-container flex-column md:flex-row justify-content-center align-items-center ">
        <div className="presentation-card">
          ...
          >
            ...
            <p>
              Dictados por el Profesor y Licenciado en Historia Lucas Botta,
              desde Córdoba (Arg.)
            </p>
        ...
        <div className="presentation-card">
          ...
          >
            ...
            <p>
              Actualmente es docente en Nivel Secundario, director de Historia
              en Podcast y escritor de Editorial Planeta.
            </p>
